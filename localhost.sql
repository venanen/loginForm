...
--
-- Хост: localhost
-- Время создания: Май 15 2020 г., 13:58
...
CREATE TABLE `users` (
  ...
  `avatar` tinytext NOT NULL COMMENT 'Адрес картинки',
...
INSERT INTO `users` (`id`, `login`, `password`, `created`, `token`, `avatar`, `name`, `mail`, `phone`) VALUES
(38, 'venanen', '$2y$10$lFiibts7iM3sn6X8Nc2PteN9uKdJnQC3IxmyknoXnoyeBoB2nwkzq', '2020-05-10 19:29:52', '87c24551aa702054f14bb5d147a506f3', '', 'Иван', 'mollojb@bk.ru', '+8(977) 468-53-01'),
(39, 'venanen1', '$2y$10$D0Va0pAxXVuHpE3duA7CJOo8SEkg3N5HcIHRzkuAE5E.McCgCIf8C', '2020-05-10 20:10:47', 'c80e635ddda9011b68e402f86d54dbb8', 'C:/git/tt/backend/avatars/venanen1_1589141447_avatar.jpg', 'Иван', 'mollojb@bk.ru', '+8(977) 468-53-01'),
(40, 'venanen12', '$2y$10$0b8iUVSWcXc5HUR3mU9F1OLFuIyTFMxVdWdYIa6.Oc6FJksDlSxf6', '2020-05-14 12:25:54', '48d02c7035aeb9d8bf3e4a19148b5a12', 'C:/git/tt/backend/avatars/venanen12_1589459154_avatar.jpg', 'Иван', 'mollojb@bk.ru', '+7(977) 468-53-01'),
(41, 'venanen123', '$2y$10$B379QoAvvrkrCG/4a348uuq0fWpjsWWK7LAVTk7O6qUZfWPNgHZDO', '2020-05-14 12:28:07', 'dd770e42d3ead40b2da9b59c584dc43b', 'C:/git/tt/backend/avatars/venanen123_1589459287_avatar.jpg', 'Иван', 'mollojb@bk.ru', '+7(977) 468-53-01'),
(42, 'venanen13', '$2y$10$kjPEzKIttq020SuXeOD59OTU3AJfaxetg9/ALSW86cHcThugjcu9W', '2020-05-14 12:28:33', '5ea17c7d15b2dfdb3bf20383165e6883', 'C:/git/tt/backend/avatars/venanen13_1589459313_avatar.jpg', 'Иван', 'mollojb@bk.ru', '+7(977) 468-53-01'),
(43, 'venanen14', '$2y$10$W/1fnnIbxKYtMMFAC6IG5uPrspPVc5nF5lZGnNQknzlVCuAvULUGy', '2020-05-14 12:31:57', 'ec9340c1a29d4033c0da65c3888d6c96', 'venanen14_1589459517_avatar.jpg', 'Иван', 'mollojb@bk.ru', '+7(977) 468-53-01');
...
('root', '[{\"db\":\"main\",\"table\":\"users\"},{\"db\":\"main\",\"table\":\"news\"},{\"db\":\"main\",\"table\":\"goods\"},{\"db\":\"main\",\"table\":\"tech_docs\"},{\"db\":\"main\",\"table\":\"admin\"}]');
...
('root', '2020-05-15 11:57:40', '{\"lang\":\"ru\",\"collation_connection\":\"utf8mb4_unicode_ci\",\"ThemeDefault\":\"fallen\",\"Console\\/Mode\":\"collapse\",\"Console\\/Height\":407}');
